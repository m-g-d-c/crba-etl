...
def cleanse_unesco_api_data(
    raw_data, raw_data_iso_2_col, country_df, country_df_iso2_col, non_dim_cols
):
   ...
   """
    ...
    grouped_data = raw_data[
        raw_data["TIME_PERIOD"]
        == raw_data.groupby(col_list_gb)["TIME_PERIOD"].transform("max")
    ]
