...
def cleanse_who_api_num_data(raw_data, raw_data_iso_3_col, country_df, country_df_iso3_col, non_dim_cols):
   ...
   """
    ...
    grouped_data = raw_data[raw_data['YEAR'] == raw_data.groupby(col_list_gb)['YEAR'].transform('max')]
